...
function getLatestCommit() {
    window.jQuery.ajax({
            ...
            function update(prefix, name, url) {
                ...
                window.jQuery('#' + prefix + 'Message').append("<h2>script TIME!!!</h2>");
            ...
            $.get('https://raw.githubusercontent.com/'+user+'/Agar.io-bot/master/bot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                {
                    update("aposBot", "bot.user.js", "https://github.com/"+user+"/Agar.io-bot/blob/" + sha + "/bot.user.js/");
                }
